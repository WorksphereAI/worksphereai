-- WorkSphere AI Minimal Signup Schema
-- Creates essential tables in correct order

-- ============================================
-- SIGNUP ATTEMPTS TABLE (no foreign dependencies)
-- ============================================
...
-- ============================================
-- EMAIL VERIFICATIONS TABLE (no foreign dependencies for now)
-- ============================================
CREATE TABLE IF NOT EXISTS email_verifications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID, -- Will reference users table later
    email VARCHAR(255) NOT NULL,
...
DO $$
BEGIN
    RAISE NOTICE '✅ WorkSphere AI Minimal Signup Schema created successfully!';

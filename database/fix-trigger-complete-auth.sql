-- ============================================
-- WORKSPHERE AI - FIX TRIGGER & COMPLETE AUTH SETUP
-- ============================================
...
SELECT 
  ...
  table_name,
  (SELECT count(*) FROM information_schema.columns WHERE table_name = information_schema.tables.table_name AND table_schema = 'public') as column_count
